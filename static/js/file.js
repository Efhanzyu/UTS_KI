...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('enc-file-password')?.addEventListener('input', () => hideStatus('enc-file-status'));
    document.getElementById('dec-file-password')?.addEventListener('input', () => hideStatus('dec-file-status'));
